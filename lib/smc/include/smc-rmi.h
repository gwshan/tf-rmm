...
#define RMI_EXIT_DEV_MEM_MAP		U(8)
...
/* RmiRttProtMapFlags - Flags for RTT_DATA_MAP and RTT_DEV_MAP commands */
#define RMI_RTT_PROT_MAP_FLAGS_OADDR_TYPE_WIDTH		UL(2)
#define RMI_RTT_PROT_MAP_FLAGS_OADDR_TYPE_SHIFT		UL(0)

#define RMI_RTT_PROT_MAP_FLAGS_LIST_COUNT_WIDTH		UL(14)
#define RMI_RTT_PROT_MAP_FLAGS_LIST_COUNT_SHIFT		UL(2)
