...
COMPILER_ASSERT_NO_CBMC(U(offsetof(struct rmi_rec_exit, s2ap_base)) == 0x520U);
COMPILER_ASSERT_NO_CBMC(U(offsetof(struct rmi_rec_exit, s2ap_top)) == 0x528U);
COMPILER_ASSERT_NO_CBMC(U(offsetof(struct rmi_rec_exit, vdev_id_1)) == 0x530U);
COMPILER_ASSERT_NO_CBMC(U(offsetof(struct rmi_rec_exit, vdev_id_2)) == 0x538U);
COMPILER_ASSERT_NO_CBMC(U(offsetof(struct rmi_rec_exit, dev_mem_base)) == 0x540U);
COMPILER_ASSERT_NO_CBMC(U(offsetof(struct rmi_rec_exit, dev_mem_top)) == 0x548U);
COMPILER_ASSERT_NO_CBMC(U(offsetof(struct rmi_rec_exit, dev_mem_pa)) == 0x550U);
COMPILER_ASSERT_NO_CBMC(U(offsetof(struct rmi_rec_exit, imm)) == 0x600U);
COMPILER_ASSERT_NO_CBMC(U(offsetof(struct rmi_rec_exit, plane)) == 0x608U);
